...
<!-- Pruned from project/decision-log.md on 2026-08-30 when the live log
     reached 19 of its 20-entry budget. Moved VERBATIM, newest first.
     These five are the founding decisions of 2026-08-28; their substance
     is restated in project/brief.md and AGENTS.md, so nothing is lost
     from working memory by their leaving the live log. -->
